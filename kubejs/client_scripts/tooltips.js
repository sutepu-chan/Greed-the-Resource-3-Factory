onEvent('item.tooltip', e => {
  ...
  e.addAdvanced('pipez:improved_upgrade', (item, advanced, text) => {
    ...
    if (e.isShift()) {
      text.add(1, [Text.of('Item: '), Text.of('16 '), Text.of('items/t')])
      text.add(2, [Text.of('Fluid: '), Text.of('500 '), Text.of('mB/t')])
      text.add(3, [Text.of('Gas: '), Text.of('2,000 '), Text.of('mB/t')])
      text.add(4, [Text.of('Energy: '), Text.of('8,192 '), Text.of('FE/t')])
    }
  })
  e.addAdvanced('pipez:advanced_upgrade', (item, advanced, text) => {
    ...
    if (e.isShift()) {
      text.add(1, [Text.of('Item: '), Text.of('32 '), Text.of('items/t')])
      text.add(2, [Text.of('Fluid: '), Text.of('2,000 '), Text.of('mB/t')])
      text.add(3, [Text.of('Gas: '), Text.of('8,000 '), Text.of('mB/t')])
      text.add(4, [Text.of('Energy: '), Text.of('32,768 '), Text.of('FE/t')])
    }
  })
  e.addAdvanced('pipez:ultimate_upgrade', (item, advanced, text) => {
    ...
    if (e.isShift()) {
      text.add(1, [Text.of('Item: '), Text.of('64 '), Text.of('items/t')])
      text.add(2, [Text.of('Fluid: '), Text.of('10,000 '), Text.of('mB/t')])
      text.add(3, [Text.of('Gas: '), Text.of('40,000 '), Text.of('mB/t')])
      text.add(4, [Text.of('Energy: '), Text.of('131,072 '), Text.of('FE/t')])
    }
  })
  e.addAdvanced('pipez:infinity_upgrade', (item, advanced, text) => {
    ...
    if (e.isShift()) {
      text.add(1, [Text.of('Item: '), Text.of('2,147,483,647 '), Text.of('items/t')])
      text.add(2, [Text.of('Fluid: '), Text.of('2,147,483,647 '), Text.of('mB/t')])
      text.add(3, [Text.of('Gas: '), Text.of('2,147,483,647 '), Text.of('mB/t')])
      text.add(4, [Text.of('Energy: '), Text.of('2,147,483,647 '), Text.of('FE/t')])
    }
  })
  //===== iron furnace =====//
